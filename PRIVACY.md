# Privacy Policy — Cert Companion

**Effective date:** 2026-08-04

Cert Companion is a Gap Hunter Labs plugin for IntelliJ Platform IDEs.
...
**Nothing.** Cert Companion does not collect, store, transmit, or sell
...
**None.** Cert Companion makes zero network calls during normal
...
None. Cert Companion has no third-party SDKs, no analytics libraries,
